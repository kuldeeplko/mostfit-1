class Target
  ...
  property :target_of,     Enum.send('[]', *TargetOf), :required => true, :index => true
  property :target_type,   Enum.send('[]', *TargetType), :required => true, :index => true

  property :start_date,    Date, :required => false, :index => true
